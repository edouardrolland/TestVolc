...
P = plume.where_meters(0)
x_c, y_c = C_wind_frame(W_direction, W_speed, d_P1P2, V_a, P)
lat, long = C_get_cpi(W_speed=10, W_direction=20, d_P1P2=10 * 1e3, V_a=21.9, t_start=0, t=0)
...
the_connection = mavutil.mavlink_connection("172.19.240.1:14550")
