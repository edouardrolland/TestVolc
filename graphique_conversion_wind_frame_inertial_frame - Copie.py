...
def process_flight_and_plot(W_speed, N, W_direction, d_P1P2, x_plane, y_plane, Yaw_Plane, logs_path, time_detection, V_a):
    ...
    return wf_x, wf_y, path_x, path_y
...
if __name__ == '__main__':
    ...
    logs_path = [r"C:\Users\edoua\Documents\Birse\Bristol\MSc Thesis\Logs des vols\Wind Effect\2500-2500-5-853904.BIN-3758576.mat", r"C:\Users\edoua\Documents\Birse\Bristol\MSc Thesis\Logs des vols\Wind Effect\2500-2500-10-1479503.BIN-3355031.mat", r"C:\Users\edoua\Documents\Birse\Bristol\MSc Thesis\Logs des vols\Wind Effect\2500-2500-15-1436383.BIN-2986719.mat", r"C:\Users\edoua\Documents\Birse\Bristol\MSc Thesis\Logs des vols\Wind Effect\2500-2500-20-2243403.BIN-3982987.mat"]

    time_detection = [853904, 1479503, 1436383, 2243403]
    V_a = 21.9
    ...
    for k in range(len(W_speed)):
        ...
        axes[k // 2, k % 2].plot(wf_x, wf_y, label=f'SITL')
        axes[k // 2, k % 2].plot(xw, yw, label=f'Theoritical windframe trajectory')
        axes[k // 2, k % 2].set_title(f'Graphique {k}')
        axes[k // 2, k % 2].legend()
        axes[k // 2, k % 2].axis('equal')
        axes[k // 2, k % 2].grid(True)
    ...
    x_inertial, y_inertial, Time, lat, long, wf_x, wf_y, path_x, path_y = cpi_trajectory(d_P1P2, V_a, W_speed, N, 0, 0, 0, 2500, 2500, 20, 20)



    plt.plot(wf_x, wf_y, label=f'SITL')
    plt.plot(xw, yw, label=f'Theoritical windframe trajectory')
    plt.legend()
    plt.axis('equal')
    plt.grid(True)
    plt.show()
