...
if __name__ == '__main__':
    ...
    Yaw_Plane = 20
    W_speed   = [5,10,15,20]
    logs_path = [r"C:\Users\edoua\Desktop\Wind Effect\2500-2500-5-853904.BIN-3758576.mat", r"C:\Users\edoua\Desktop\Wind Effect\2500-2500-10-1479503.BIN-3355031.mat", r"C:\Users\edoua\Desktop\Wind Effect\2500-2500-15-1436383.BIN-2986719.mat", r"C:\Users\edoua\Desktop\Wind Effect\2500-2500-20-2243403.BIN-3982987.mat"]
    ...
    Time_Waypoint = [853904, 871663, 888403, 905924, 922924, 939424, 956423, 974424, 991404, 1009664, 1018903, 1153644, 1287443, 1417403, 1544904, 1669403, 1791923, 1913644, 2037663, 2165163, 2296924, 2429903, 2565163]
    ...
    for k in range(len(Time_Waypoint)):
        if k == 0:
            indice = 0
        else:

            indice = Temps.index(np.around(Time_Waypoint[k]*1e-3))
