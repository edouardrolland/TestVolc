...
from Route_E_CPI import  cpi_trajectory, E_wind_frame, extract_circle_points, cpi_trajectory_corrected
...
altitude = [4700 for _ in range (len(lat))]
...
xh, yh = find_home(20e3, x1, y1, x2, y2)
...
the_connection = mavutil.mavlink_connection("172.20.112.1:14550")
